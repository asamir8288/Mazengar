...
Doctrine_Manager::getInstance()->bindComponent('ShopAlbums', 'default');
 ...
 * @property Doctrine_Collection $ShopAlbumImages
 * 
 * @package    ##PACKAGE##
 ...
 */
abstract class BaseShopAlbums extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('shop_albums');
        ...
        $this->hasColumn('album_order', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             'fixed' => false,
             'unsigned' => false,
    ...
    public function setUp()
    {
        ...
        $this->hasMany('ShopAlbumImages', array(
             'local' => 'id',
             'foreign' => 'album_id'));
    }
}