$(document).ready(function(){
    ...
    $('.add-video-btn').live("click",function(){				
        ...
        //$(this).parent().parent().append('<iframe class="youtube-video-frame" width="470" height="345" border="0" src="' + youtubeLink + '"></iframe>');			-->
        ...
        $(".select-files-anchor").uploadify ({
            ...
            'onComplete' : function(event,queueID,fileObj,response,data) {
                ...
                {								  
                    ...
                    imageToChange.append('<img class="product-image"  src="'+site_url() +'uploads/' + fileObj.name + '" /><a class="upload-product-image-anchor" id="offer-img">Upload Another Cover Image</a>');                    													
    ...
    /*
					...
					'onComplete' : function(event,queueID,fileObj,response,data) {
							...
							if(fileObj.type.toLowerCase() == '.jpg' || fileObj.type.toLowerCase() == '.jpeg' || fileObj.type.toLowerCase() == '.png' || fileObj.type.toLowerCase() == '.gif')
							{
								...
								parentAppend.find('object').eq(0).remove();
								$(".product-image").remove();
								parentAppend.append('<img class="product-image" src="uploads/' + fileObj.name + '" /><a class="upload-product-image-anchor" id="offer-img">Upload Another Cover Image</a>');                    					
							}else{
							alert('Upload Failure: Only images with the following extenstions jpg, jpeg, png, gif are allowed.');
							}
						},
        ...
        $(".select-files-anchor").uploadify ({
            ...
            'onComplete' : function(event,queueID,fileObj,response,data) {
                ...
                if(fileObj.type.toLowerCase() == '.jpg' || fileObj.type.toLowerCase() == '.jpeg' || fileObj.type.toLowerCase() == '.png' || fileObj.type.toLowerCase() == '.gif')
                {
                    ...
                    imageToChange.append('<div class="uploaded-img-wrapper"><img  src="'+site_url() +'uploads/' + fileObj.name + '"/></div>');    
