...
$(document).ready(function(){
    ...
    /*	$('.mainmenu-name').focus(function() {
					
					$(this).animate({ opacity: 1, width: "200px" }, 'medium');
                    

                    });	
					
					$('.mainmenu-name').blur(function() {
					
					$(this).animate({ opacity: 1, width: "100px" }, 'medium');
...
$(document).ready(function(){
    ...
    /* $(".open-image-icon").live("click",function(){		
        ...
        $(".select-files-anchor").uploadify ({
            ...
            'onComplete' : function(event,queueID,fileObj,response,data) {
                ...
                if(fileObj.type.toLowerCase() == '.jpg' || fileObj.type.toLowerCase() == '.jpeg' || fileObj.type.toLowerCase() == '.png' || fileObj.type.toLowerCase() == '.gif')
                {
                    ...
                    imageToChange.prepend('<img class="mainmenu-image" src="uploads/' + fileObj.name + '" />');       
